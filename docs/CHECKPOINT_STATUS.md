...
| V1.6.1 Product surface unification | In progress | First-party Clerk sign-in/sign-up, unified Product/Free Tools/Workspace navigation, honest Quick Generate/Coverage Review/Release Review framing, and an evidence-workflow homepage for the primary QA/SDET audience are implemented. Durable free-tool-to-workspace handoff and legacy Debug/Figma de-emphasis remain. |
