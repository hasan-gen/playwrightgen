...
| V1.6.1 Product surface unification | In progress | First-party Clerk sign-in/sign-up, unified Product/Free Tools/Workspace navigation, and honest Quick Generate/Coverage Review/Release Review framing are implemented. Home-page repositioning and durable free-tool-to-workspace handoff remain. |
