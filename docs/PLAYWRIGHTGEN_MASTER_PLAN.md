...
- Tenant-safe GitHub setup, repository import, and signed installation lifecycle: live Preview proof complete for an exact-ref public import; private-repository and controlled-execution proof remain.
