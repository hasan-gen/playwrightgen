...
**Not production-ready.** Authentication, the tenant schema, and verified Clerk
synchronization exist. Server authorization, real project workflows, core V1
domain workflows, production operations, and deployment validation remain.
...
| Tenant authorization | Missing | Checkpoint 5 permissions and cross-tenant negative tests. |
